...
namespace WinApp.Estructuras.EstandarUbl
{
    ...
    public class CreditNote : IXmlSerializable, IEstructuraXml
    {
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteStartElement("cbc:CreditNoteTypeCode");
            ...
            writer.WriteAttributeString("listName", InvoiceTypeCode2.listName);
            writer.WriteAttributeString("listURI", InvoiceTypeCode2.listURI);
            writer.WriteValue("07"); //Tipo de Documento 07 NC
            writer.WriteEndElement();
            ...
            foreach (var creditNoteLine in CreditNoteLines)
            {
                ...
                if (creditNoteLine.ItemClassificationCode != "" && creditNoteLine.ItemClassificationCode != null)
                {
